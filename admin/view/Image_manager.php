...
<div class="col-md-12"><h1 align="center"><b>Images in site</b></h1></div>
	<?php foreach ($image as $key => $value) {?>
		<div class="col-md-4 navbar  navbar-default" style="padding:30px;">
			 <a class="example-image-link" href="../admin/static/images/pageImage/<?= $value['image'] ?>" data-lightbox="gallery"><img src="../admin/static/images/pageImage/<?= $value['image'] ?>" width="300" height="250" style="padding: 10px;"><br></a>
			<form method="post" >
